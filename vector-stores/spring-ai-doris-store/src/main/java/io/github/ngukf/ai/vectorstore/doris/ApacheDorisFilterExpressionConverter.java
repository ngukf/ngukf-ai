...
/**
 * Converts {@link Expression} into JSON metadata filter expression format for Apache Doris.
 *
 * @author ngukf
 */
public class ApacheDorisFilterExpressionConverter extends AbstractFilterExpressionConverter {

    private final String metadataFieldName;

    public ApacheDorisFilterExpressionConverter(String metadataFieldName) {
